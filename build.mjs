...
const sources=['game.js','crimson-deck.js','midnight-deck.js','gorgon-deck.js','common-deck.js','golden-deck.js','judge-deck.js','hours-deck.js','server/engine-adapter.js'].map(f=>fs.readFileSync(path.join(root,f),'utf8')).join('\n');
